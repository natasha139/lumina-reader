...
import { BookmarkPlus, MessageSquarePlus, LayoutTemplate, ArrowLeft, Bold, Italic, Underline, Highlighter, Eraser, Languages } from 'lucide-react';
          ...
          <div className="md:col-span-4 bg-[#fafafa] p-8 md:p-10 flex flex-col gap-12 border-l border-gray-100">
            ...
            <section>
              ...
              <div className="space-y-4">
                {vocabularies.map(v => (
                  <div key={v.id} className="bg-white p-5 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100/50 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-shadow">
            ...
            <section>
              ...
              <div className="space-y-4">
                {notes.map(n => (
                  <div key={n.id} className="bg-white p-5 rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-gray-100/50 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-shadow">
            ...
            {popupMode === 'vocab' && (
              <div className="p-4 flex flex-col gap-4">
                <div className="flex items-center gap-2">
                  <div className="w-1 h-4 bg-xhs-red rounded-full" />
                  <div className="font-serif font-black text-xhs-red truncate text-lg">{selection.text}</div>
                </div>
                <input 
                  autoFocus
                  type="text" 
